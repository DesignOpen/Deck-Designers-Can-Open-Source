...
var Notes, React, Site, Slide, sizzle, slides;
...
Site = React.createClass({
  ...
  render: function() {
    ...
    return React.createElement("div", {
      ...
      ref = this.props.slides;
      results = [];
      for (index = i = 0, len = ref.length; i < len; index = ++i) {
        slideItem = ref[index];
        results.push(React.createElement(Slide, {
          "key": index,
          "img": slideItem.img,
          "slideState": this.getSlideState(index)
        }));
      }
      return results;
...
},{"./notes":160,"./slide":161,"./slides.cson":162,"react":158,"sizzle":159}],2:[function(require,module,exports){
